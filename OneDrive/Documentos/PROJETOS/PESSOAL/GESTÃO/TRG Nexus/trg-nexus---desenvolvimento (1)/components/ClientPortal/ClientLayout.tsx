...
import { LayoutDashboard, Calendar, BookOpen, User, LogOut, ShieldCheck, Menu, X, Video, Film } from 'lucide-react';
                ...
                <div className="p-4">
                    <div className="mb-6 px-4 py-3 bg-primary-50 dark:bg-primary-900/10 rounded-xl border border-primary-100 dark:border-primary-900/30 flex items-center justify-between">
                        <div>
                            ...
                            <p className="font-bold text-slate-800 dark:text-white truncate">Paciente</p>
                        </div>
