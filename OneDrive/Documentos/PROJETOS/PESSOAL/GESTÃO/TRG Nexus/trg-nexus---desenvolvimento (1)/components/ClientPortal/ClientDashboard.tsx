            ...
            <div className="space-y-6 animate-fade-in pb-20 md:pb-0">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0 no-scrollbar w-full lg:w-auto">
                        <a href="/portal-paciente/agendamentos" className="flex items-center gap-2 px-4 py-2 bg-primary-600 dark:bg-primary-600 text-white rounded-xl shadow-lg shadow-primary-500/20 dark:shadow-primary-600/20 hover:bg-primary-700 dark:hover:bg-primary-700 transition-all active:scale-95 whitespace-nowrap">
                            <Calendar size={18} />
                        ...
                        {nextAppointment ? (
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center justify-between mt-6">
                                    ...
                                    <a
                                        href={`/sessao-cliente/${nextAppointment.id}`}
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                ...
                                <div className="mt-4">
                                    <a href="/portal-paciente/agendamentos" className="text-sm font-bold text-primary-600 hover:underline">Agendar agora &rarr;</a>
                                </div>
                            </div>
                        )}
                    </div>
