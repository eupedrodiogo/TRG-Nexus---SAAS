      ...
      <section className="py-20 bg-slate-900/30 border-y border-slate-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto mb-12">
            O TRG Nexus foi construído seguindo as diretrizes da LGPD para garantir que os dados de seus pacientes estejam sempre seguros e sob seu controle.
          </p>
      ...
      < footer className="bg-slate-950 border-t border-slate-900 py-16" >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8">
            ...
            <a href="mailto:contato@trgnexus.com" className="text-slate-300 hover:text-white text-sm font-bold transition-colors">Contato</a>
          </div>
        </div>
      </footer >
